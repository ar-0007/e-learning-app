...
const Logo = () => (
  <div className="flex items-center space-x-2">
    <div className="w-10 h-10 bg-luxury-orange rounded-lg flex items-center justify-center">
      <CarIcon />
    </div>
        ...
        <div className="container-custom">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#about" className="text-gray-700 hover:text-luxury-orange transition-colors">About</a>
              <a href="#courses" className="text-gray-700 hover:text-luxury-orange transition-colors">Courses</a>
              <a href="#how-it-works" className="text-gray-700 hover:text-luxury-orange transition-colors">How It Works</a>
              <a href="#mentorship" className="text-gray-700 hover:text-luxury-orange transition-colors">Mentorship</a>
              <a href="#contact" className="text-gray-700 hover:text-luxury-orange transition-colors">Contact</a>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#courses" className="hover:text-luxury-orange transition-colors">Courses</a></li>
                <li><a href="#mentorship" className="hover:text-luxury-orange transition-colors">Mentorship</a></li>
                <li><a href="#" className="hover:text-luxury-orange transition-colors">Podcasts</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Account</h4>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-luxury-orange transition-colors">Login</a></li>
                <li><a href="#" className="hover:text-luxury-orange transition-colors">Admin Panel</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Support</h4>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#contact" className="hover:text-luxury-orange transition-colors">Contact</a></li>
                <li><a href="#" className="hover:text-luxury-orange transition-colors">Help Center</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Luxury Auto Spa – Detailers University. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
